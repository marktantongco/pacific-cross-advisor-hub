    ...
    <div className="space-y-6 pb-8">
          ...
          <div className="grid grid-cols-2 gap-3">
            {contentPillars.map((pillar, i) => (
              <RevealSection key={i} delay={i * 80}>
                <div className="hover-card p-4 h-full" style={{ borderLeft: `4px solid ${pillar.color}` }}>
      ...
      {view === 'campaign' && (
        <div className="space-y-4">
          ...
          <RevealSection>
            <div className="p-5 text-center" style={{ background: 'var(--bg)', border: '2px solid var(--accent-red)' }}>
