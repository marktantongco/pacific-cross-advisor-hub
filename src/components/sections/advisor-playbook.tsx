              ...
              <div className="panel">
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2">
                    <span className="tag tag-red">{tpl.category}</span>
          ...
          <RevealSection delay={500}>
            <div className="panel">
              ...
              <div className="grid grid-cols-2 gap-2">
                {[
                  { label: 'Conversations', target: '25' },
                  { label: 'Follow-ups', target: '15' },
                  { label: 'Social Posts', target: '5' },
                  { label: 'New Leads', target: '10' },
                ].map((item, i) => (
                  <div key={i} className="text-center p-3" style={{ background: 'var(--bg-elevated)', border: '1px solid var(--border)' }}>
                    <p className="stat-label">{item.label}</p>
                    <p className="font-display text-2xl" style={{ color: 'var(--accent-red)' }}>{item.target}</p>
                    <p className="font-mono" style={{ color: 'var(--text-dim)', fontSize: '0.6rem' }}>/ week</p>
                  </div>
                ))}
              </div>
            </div>
