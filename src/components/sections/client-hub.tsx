        ...
        <div className="space-y-4">
          ...
          <RevealSection delay={100}>
            <div className="overflow-x-auto" style={{ border: '2px solid var(--border)', scrollbarWidth: 'thin' }}>
              <div className="grid grid-cols-3 p-3" style={{ background: 'var(--bg)' }}>
                <span className="font-sub text-xs text-left" style={{ color: 'var(--text)' }}>Feature</span>
                <span className="font-sub text-xs text-center" style={{ color: 'var(--accent-red)' }}>👑 Blue Royale</span>
                <span className="font-sub text-xs text-center" style={{ color: 'var(--accent-yellow)' }}>🛡️ FlexiShield</span>
              </div>
              {comparisonRows.map((row, i) => (
                <div
                  key={i}
                  className="grid grid-cols-3 p-2.5 font-mono"
                  style={{
                    fontSize: '0.65rem',
                ...
                >
                  <span className="text-left font-bold">{row.feature}</span>
                  <span className="text-center">{row.blue}</span>
                  <span className="text-center">{row.flexi}</span>
                </div>
              ))}
            </div>
          </RevealSection>
          ...
          <RevealSection delay={100}>
            {estimatorProduct === 'fs' ? (
              <div className="panel" style={{ border: '2px solid var(--accent-yellow)' }}>
                ...
                {fsPremium ? (
                  <div className="p-4 text-center" style={{ background: 'var(--bg)', border: '2px solid var(--accent-yellow)' }}>
                    ...
                    <p className="font-display text-4xl mb-1" style={{ color: 'var(--accent-yellow)' }}>
              ...
              <div className="panel" style={{ border: '2px solid var(--accent-red)', background: 'var(--bg)' }}>
        ...
        <div className="space-y-4">
          ...
          {[
            ...
            <RevealSection key={i} delay={Math.min(i * 30, 300)}>
              <div className="hover-card p-4" style={{ borderLeft: '3px solid var(--accent-red)' }}>
                <div className="flex items-start gap-3">
          ...
          <RevealSection>
            <p className="font-sub text-sm mt-4" style={{ color: 'var(--accent-yellow)' }}>🛡️ FlexiShield Benefits</p>
          </RevealSection>
          {[
            ...
            <RevealSection key={i} delay={Math.min(i * 30, 300)}>
              <div className="hover-card p-4" style={{ borderLeft: '3px solid var(--accent-yellow)' }}>
                <div className="flex items-start gap-3">
                  <span className="text-xl">{item.emoji}</span>
                  <div>
